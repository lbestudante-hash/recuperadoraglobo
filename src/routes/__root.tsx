  ...
  head: () => ({
    meta: [
      ...
      { title: "Recuperadora Tecnologia — TI que mantém empresas em operação" },
      {
        name: "description",
        content:
          "Suporte técnico, software empresarial, automação, infraestrutura e inteligência artificial para empresas, escolas e órgãos públicos.",
      },
      { name: "author", content: "Recuperadora Tecnologia" },
      ...
      { name: "twitter:site", content: "@recuperadora" },
    ],
    links: [
      {
        rel: "stylesheet",
